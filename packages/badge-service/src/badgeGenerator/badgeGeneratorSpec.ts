...
//   let mutationTestingReportMapper: sinon.SinonStubbedInstance<MutationTestingReportMapper>;
//   let context: any;
//   const req = undefined;
//   let getContentStub: sinon.SinonStub;
//   let mutationTestingReport: MutationTestingReport;
//   let logErrorStub: sinon.SinonStub;
//   const unknownBadge = fs.readFileSync(path.resolve(__dirname, '..', 'mutation-score-unknown-lightgrey.svg'), 'utf8');

//   beforeEach(() => {
//     mutationTestingReportMapper = sinon.createStubInstance(MutationTestingReportMapper);
//     sinon.stub(dataAccessModule, 'MutationTestingReportMapper').returns(mutationTestingReportMapper);
...
//     const mutationScoreNoBranch: MutationTestingReport = {
...
//     mutationTestingReportMapper.findOne.withArgs('github.com/stryker-mutator/stryker', 'master')
//       .resolves(mutationTestingReport);
//     mutationTestingReportMapper.findOne.withArgs('github.com/stryker-mutator/stryker', '')
...
//     mutationTestingReportMapper.select.reset();
//     mutationTestingReportMapper.select.throws(error);
...
//     mutationTestingReport.score = 79.95;
...
//     mutationTestingReport.score = 79.9465;
...
//     // Arrange
//     getContentStub.resolves('orange');
//     mutationTestingReport.score = 59.95;
...
//     mutationTestingReport.score = 59.9;

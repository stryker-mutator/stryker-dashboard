...
export class StatusBoxComponent extends BaseElement {
  ...
  render() {
    ...
    ${this.boxes.map(({ value, label, color }) => html`
      <div class="flex flex-col items-center flex-nowrap md:border-[3px] border-b-2  border-neutral-600 md:hover:bg-neutral-700/25 md:hover:border-opacity-95 md:px-4 md:py-2 py-16 md:rounded sm:w-52 px-0 w-48 h-fit duration-150 hover:shadow-sm max-md:last:border-none ">

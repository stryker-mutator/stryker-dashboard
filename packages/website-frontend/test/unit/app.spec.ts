import { StrykerDashboard } from '../../src/app.ts';
...
describe(StrykerDashboard.name, () => {
  ...
  it('should render the home page', async () => {
    ...
    const main = sut.element.querySelector('main');
  ...
  it('should sign in when sign-in is clicked', async () => {
    ...
    sut.connect();
    await sut.whenStable();
    const signInButton = sut.element
      .querySelector('sme-top-bar')
      ?.querySelector('sme-button') as unknown as HTMLButtonElement;
    signInButton?.click();
